    ...
    <section className="w-full h-full min-h-0 bg-[var(--color-secondary-white)]">
      <div className="h-full w-full flex flex-col">
        <div className="flex-1 min-h-0 w-full min-w-0 flex flex-col lg:flex-row gap-6 overflow-hidden">
          ...
          <div
            ref={cardsScrollRef}
            className="py-4 px-6 sm:px-[56px] lg:px-2 lg:py-8 w-full max-w-[1500px] m-auto flex-1 min-h-0 h-full overflow-auto overscroll-contain scrollbar-hide [-webkit-overflow-scrolling:touch]"
          >
