...
import type { TalentProfileResponse } from '../../talent/talent-profile-edit/types/talentProfile.types';
import SocialMediaSection from './SocialMediaSection';
import ViewerActions from './ViewerActions';

const BasicInfoSection = ({ data, isOwner }: { data: TalentProfileResponse; isOwner: boolean }) => {
      ...
      {isDesktop ? (
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-row items-center gap-4">
            ...
            {isOwner && <TalentProfileModeToggle isEdit={false} publicSlug={data.publicSlug} />}
          </div>
        </div>
      ) : (
